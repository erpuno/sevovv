...
-module(smtp_rfc5322_scan).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/smtp_rfc5322_scan.xrl", 36).
...
-file("src/smtp_rfc5322_scan.erl", 307).
yystate() -> 16.
...
yystate(16, [64|Ics], Line, Tlen, Action, Alen) ->
...
yystate(16, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 39 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 47, C =< 57 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 94, C =< 126 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 128, C =< 2047 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 2048, C =< 55295 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 57344, C =< 65533 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 65536, C =< 1114111 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 94, C =< 126 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 128, C =< 2047 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 2048, C =< 55295 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 57344, C =< 65533 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65536, C =< 1114111 ->
    yystate(14, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Tlen+1, 2, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 94 ->
    yystate(3, Ics, Line, Tlen+1, 2, Tlen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 91 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 94 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [10|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line+1, Tlen+1, 1, Tlen);
...
-file("src/smtp_rfc5322_scan.xrl", 12).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/2}).
-file("src/smtp_rfc5322_scan.xrl", 16).
yyaction_1(TokenChars, TokenLine) ->
     { token, { qstring, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("src/smtp_rfc5322_scan.xrl", 20).
yyaction_2(TokenChars, TokenLine) ->
     { token, { domain_literal, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/smtp_rfc5322_scan.xrl", 23).
yyaction_3(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("src/smtp_rfc5322_scan.xrl", 25).
yyaction_4(TokenLine) ->
     { token, { '<', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/smtp_rfc5322_scan.xrl", 26).
yyaction_5(TokenLine) ->
     { token, { '>', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/smtp_rfc5322_scan.xrl", 27).
yyaction_6(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/smtp_rfc5322_scan.xrl", 28).
yyaction_7(TokenLine) ->
     { token, { '@', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/smtp_rfc5322_scan.xrl", 29).
yyaction_8(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/smtp_rfc5322_scan.xrl", 31).
yyaction_9(TokenLine) ->
     { token, { ':', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/smtp_rfc5322_scan.xrl", 32).
yyaction_10(TokenLine) ->
     { token, { ';', TokenLine } } .
