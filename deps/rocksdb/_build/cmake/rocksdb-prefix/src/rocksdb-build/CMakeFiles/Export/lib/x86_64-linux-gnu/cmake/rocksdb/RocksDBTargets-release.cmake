...
set_target_properties(RocksDB::rocksdb-shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/librocksdb.so.6.13.3"
  IMPORTED_SONAME_RELEASE "librocksdb.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS RocksDB::rocksdb-shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_RocksDB::rocksdb-shared "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/librocksdb.so.6.13.3" )
